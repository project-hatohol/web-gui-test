...
class FRegistNagios(unittest.TestCase):
    ...
    def test_f_regist_nagios(self):
        ...
        Select(driver.find_element_by_id("selectServerType")).select_by_visible_text("Zabbix")
        driver.find_element_by_id("server-edit-dialog-param-form-0").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-0").send_keys("zab1")
        driver.find_element_by_id("server-edit-dialog-param-form-1").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-1").send_keys("zab1")
        driver.find_element_by_id("server-edit-dialog-param-form-2").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-2").send_keys("10.0.3.11")
        ...
        driver.find_element_by_id("server-edit-dialog-param-form-5").send_keys("zabbix")
        ...
        try: self.assertEqual("zab1", driver.find_element_by_xpath("//table[@id='table']/tbody/tr[" + str(tr_size - 1) + "]/td[4]").text)
