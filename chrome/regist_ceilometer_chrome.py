...
class FRegistNagios(unittest.TestCase):
    ...
    def test_f_regist_nagios(self):
        ...
        Select(driver.find_element_by_id("selectServerType")).select_by_visible_text("Ceilometer")
        driver.find_element_by_id("server-edit-dialog-param-form-0").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-0").send_keys("ceilo1")
        driver.find_element_by_id("server-edit-dialog-param-form-1").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-1").send_keys("http://controller:35357/v2.0")
        driver.find_element_by_id("server-edit-dialog-param-form-4").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-4").send_keys("admin")
        driver.find_element_by_id("server-edit-dialog-param-form-5").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-5").send_keys("admin")
        driver.find_element_by_id("server-edit-dialog-param-form-6").clear()
        driver.find_element_by_id("server-edit-dialog-param-form-6").send_keys("hatohol")
        ...
        try: self.assertEqual("http://controller:35357/v2.0", driver.find_element_by_xpath("//table[@id='table']/tbody/tr[" + str(tr_size - 1) + "]/td[4]").text)
